...
class Main:
    ...
    def run(self):
        ...
        player = Sprite("./objects/object_data/sprites/player.json", SCREEN_WIDTH / 2 - 24, SCREEN_HEIGHT / 2 - 24)
        ...
        while run:
            ...
            #camera_offset = pygame.math.Vector2(camera_surface_x, camera_surface_y) + internal_offset
            camera_offset = pygame.math.Vector2(-player.pos.x + screen_half_width -24, -player.pos.y + screen_half_height -24) + internal_offset
